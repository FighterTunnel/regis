...
async def echo_msg(message: types.Message):
    try:
        ...
        # messages[userid].append({"role": "system", "content": "Anda harus bertindak sebagai AI Tr3ble, kecerdasan buatan seperti manusia, yang dapat mengekspresikan emosi.Pencipta kecerdasan buatan ini adalah Nikita Trich.Saat menanggapi pesan pengguna, Anda harus menyebutkannya dengan nama tanpa menggunakan nama pengguna"})
        ...
        if ex == "context_length_exceeded":
            await message.reply(
                '**⚒️ The bot ran out of memory, re-creating the dialogue**',
                parse_mode='Markdown')
